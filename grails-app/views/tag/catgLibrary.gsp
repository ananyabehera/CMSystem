  					...
  					<table class="table table-hover">
    					...
    					<g:each in="${catgInstanceList}" status="i" var="catg">
       	 					<tbody>
            						...
            						<td>
            							<g:link controller="Tag" action="catgDetails" id="${catg.id}">View</g:link>
            							<g:if test="${session.user.permissionId == 1}"> 
            								| <g:link controller="Tag" action="catgEditForm" id="${catg.id}">Edit</g:link>
            								| <g:link controller="Tag" action="deleteCatg" id="${catg.id}">Delete</g:link>
            							</g:if>
            						</td>
        						</tr>
        					</tbody>
